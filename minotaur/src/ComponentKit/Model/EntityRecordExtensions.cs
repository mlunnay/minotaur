...
namespace ComponentKit.Model {
    ...
    public static class EntityRecordExtensions {
        ...
        public static IEntityRecord CreateChild(this IEntityRecord parent, string name, params IComponent[] components)
        {
          IEntityRecord record = Entity.Create(name, components);
          record.Parent = record;
          return record;
        }
